...
package jef.com.sun.xml.bind.v2.runtime.reflect;
...
import jef.com.sun.xml.bind.v2.runtime.reflect.opt.OptimizedAccessorFactory;
import jef.com.sun.xml.bind.v2.runtime.unmarshaller.Loader;
import jef.com.sun.xml.bind.v2.runtime.unmarshaller.Receiver;
...
public abstract class Accessor<BeanT,ValueT> implements Receiver {
    ...
    public final <T> Accessor<BeanT,T> adapt(Adapter<Type,ClassEx> adapter) {
        return new AdaptedAccessor<BeanT,ValueT,T>(
            ...
            this,
            (Class<? extends XmlAdapter<T, ValueT>>) adapter.adapterType.getWrappered());
    }
    ...
    public static class FieldReflection<BeanT,ValueT> extends Accessor<BeanT,ValueT> {
        public final FieldEx f;

        private static final Logger logger = Util.getClassLogger();

        public FieldReflection(FieldEx f) {
    ...
    public static final class ReadOnlyFieldReflection<BeanT,ValueT> extends FieldReflection<BeanT,ValueT>{
        public ReadOnlyFieldReflection(FieldEx f) {
            super(f);
        }
    ...
    public static class GetterSetterReflection<BeanT,ValueT> extends Accessor<BeanT,ValueT> {
        public final MethodEx getter;
        public final MethodEx setter;

        private static final Logger logger = Util.getClassLogger();

        public GetterSetterReflection(MethodEx getter, MethodEx setter) {
            super(
        ...
        private void makeAccessible(MethodEx m) {
    ...
    public static class GetterOnlyReflection<BeanT,ValueT> extends GetterSetterReflection<BeanT,ValueT> {
        public GetterOnlyReflection(MethodEx getter) {
            super(getter,null);
        }
    ...
    public static class SetterOnlyReflection<BeanT,ValueT> extends GetterSetterReflection<BeanT,ValueT> {
        public SetterOnlyReflection(MethodEx setter) {
            super(null,setter);
        }
