...
package jef.com.sun.xml.bind.v2.model.annotation;
...
public final class RuntimeInlineAnnotationReader extends AbstractInlineAnnotationReaderImpl<Type,ClassEx,FieldEx,MethodEx>
    ...
    public boolean hasFieldAnnotation(Class<? extends Annotation> annotationType, FieldEx field) {
    ...
    public Annotation[] getAllFieldAnnotations(FieldEx field, Locatable srcPos) {
    ...
    public <A extends Annotation> A getMethodAnnotation(Class<A> annotation, MethodEx method, Locatable srcPos) {
        return LocatableAnnotation.create(method.getAnnotation(annotation),srcPos);
    }

    public boolean hasMethodAnnotation(Class<? extends Annotation> annotation, MethodEx method) {
        return method.isAnnotationPresent(annotation);
    }

    public Annotation[] getAllMethodAnnotations(MethodEx method, Locatable srcPos) {
    ...
    public <A extends Annotation> A getMethodParameterAnnotation(Class<A> annotation, MethodEx method, int paramIndex, Locatable srcPos) {
    ...
    protected String fullName(MethodEx m) {
