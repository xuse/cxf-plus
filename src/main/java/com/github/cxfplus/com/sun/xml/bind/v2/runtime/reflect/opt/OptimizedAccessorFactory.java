...
package com.github.cxfplus.com.sun.xml.bind.v2.runtime.reflect.opt;

import static com.github.cxfplus.com.sun.xml.bind.v2.bytecode.ClassTailor.toVMClassName;
import static com.github.cxfplus.com.sun.xml.bind.v2.bytecode.ClassTailor.toVMTypeName;
...
public abstract class OptimizedAccessorFactory {
     ...
     */
    public static final <B,V> Accessor<B,V> get(MethodEx getter, MethodEx setter) {
        ...
        Class t = getter.getJavaMethod().getReturnType();
     ...
     *      if for some reason it fails to create an optimized version.
     */
    public static final <B,V> Accessor<B,V> get(FieldEx field) {
