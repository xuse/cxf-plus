...
package com.github.cxfplus.com.sun.xml.bind;
...
public interface AccessorFactory {
     ...
     */
    Accessor createFieldAccessor(Class bean, FieldEx f, boolean readOnly) throws JAXBException;
     ...
     * @throws JAXBException reports failures of the method.     
     */
    Accessor createPropertyAccessor(Class bean, MethodEx getter, MethodEx setter) throws JAXBException;
}
