...
import com.github.cxfplus.com.sun.xml.bind.v2.runtime.reflect.Lister;
import com.github.cxfplus.com.sun.xml.bind.v2.runtime.reflect.NullSafeAccessor;
import com.github.cxfplus.com.sun.xml.bind.v2.runtime.unmarshaller.ChildLoader;
import com.github.cxfplus.com.sun.xml.bind.v2.runtime.unmarshaller.DefaultValueLoaderDecorator;
...
abstract class ArrayElementProperty<BeanT,ListT,ItemT> extends ArrayERProperty<BeanT,ListT,ItemT> {
    ...
    protected ArrayElementProperty(JAXBContextImpl grammar, RuntimeElementPropertyInfo prop) {
        ...
        for (RuntimeTypeRef typeRef : types) {
            Class type = GenericUtils.getRawClass(typeRef.getTarget().getType());
            if(type.isPrimitive())
