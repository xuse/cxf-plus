...
import com.github.cxfplus.com.sun.xml.bind.AccessorFactory;
import com.github.cxfplus.com.sun.xml.bind.AccessorFactoryImpl;
import com.github.cxfplus.com.sun.xml.bind.XmlAccessorFactory;
...
import com.github.cxfplus.com.sun.xml.bind.v2.ClassFactory;
...
import com.github.cxfplus.com.sun.xml.bind.v2.model.runtime.RuntimeElement;
import com.github.cxfplus.com.sun.xml.bind.v2.model.runtime.RuntimePropertyInfo;
import com.github.cxfplus.com.sun.xml.bind.v2.model.runtime.RuntimeValuePropertyInfo;
...
class RuntimeClassInfoImpl extends ClassInfoImpl<Type,ClassEx,FieldEx,MethodEx>
    ...
    @Override
    protected RuntimePropertySeed createFieldSeed(FieldEx field) {
       final boolean readOnly = Modifier.isStatic(field.getModifiers());
        Accessor acc;
        try {
            acc = accessorFactory.createFieldAccessor(clazz.getWrappered(), field, readOnly);
    ...
    @Override
    public RuntimePropertySeed createAccessorSeed(MethodEx getter, MethodEx setter) {
        Accessor acc;
        try {
            acc = accessorFactory.createPropertyAccessor(clazz.getWrappered(), getter, setter);
        } catch(JAXBException e) {
            builder.reportError(new IllegalAnnotationException(
    ...
    @Override
    protected void checkFieldXmlLocation(FieldEx f) {
