...
package com.github.cxfplus.jaxbplus.io;
...
import com.github.cxfplus.jaxbplus.JAXBEncoderDecoder;
...
public class DataReaderImpl<T> extends JAXBDataBase implements DataReader<T> {
    ...
    public Object read(MessagePartInfo part, T reader) {
        ...
        XmlJavaTypeAdapter adapter=JefAdapters.get(part.getTypeClass());
        if (honorJaxbAnnotation || adapter!=null) {
            if(adapter!=null){
            	anns=new Annotation[]{adapter};
            }else{
